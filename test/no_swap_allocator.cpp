...
std::unordered_multiset<int, std::hash<int>, std::equal_to<int>, uut_allocator> test_unordered_multiset;
std::unordered_multimap<int, std::hash<int>, std::equal_to<int>, uut_allocator> test_unordered_multimap;
...
class unserialized_no_swap_allocator_typed_test: public ::testing::Test {
  protected:
    ...
    std::unique_ptr<ec::unserialized_no_swap_allocator<TypeParam, mock::monitored_allocator<TypeParam>>> allocator;

    virtual void SetUp()
    {
        memory->reset();
        allocator = std::make_unique<ec::unserialized_no_swap_allocator<TypeParam, mock::monitored_allocator<TypeParam>>>();
