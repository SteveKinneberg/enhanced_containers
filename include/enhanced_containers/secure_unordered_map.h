/**
 * @file
 * A collection of aliases to `std::unordered_map` that use the secure allocators.
 *
...
/**
 * @brief
 * Alias of `std::unordered_map<>` that wraps the real alloctor with `ec::unserialized_secure_allocator<>`.
 *
 * @tparam Key          The key type stored in the unordered_map.
 * @tparam T            The value type stored in the unordered_map.
...
/**
 * @brief
 * Alias of `std::unordered_map<>` that wraps the real alloctor with `ec::serialized_secure_allocator<>`.
 *
 * @tparam Key          The value type stored in the unordered_map.
 * @tparam T            The value type stored in the unordered_map.
 * @tparam Hash         The hash functor type.
 * @tparam KeyEqual     The equal functor type for Key.
 * @tparam Allocator    The real allocator (default: `std:allocator<Key>`).
