/**
 * @file
 * A collection of aliases to `std::set` that use the secure allocators.
 *
...
/**
 * @brief
 * Alias of `std::set<>` that wraps the real alloctor with `ec::unserialized_secure_allocator<>`.
 *
...
/**
 * @brief
 * Alias of `std::set<>` that wraps the real alloctor with `ec::serialized_secure_allocator<>`.
 *
 * @tparam Key          The key type stored in the set.
 * @tparam Compare      The comparison functor type.
 * @tparam Allocator    The real allocator (default: `std:allocator<Key>`).
